export const codeVibesSelectionTemplate = `<div class="theme-visual">
                ...
                <div class="theme-visual_cards">
                  <img src="assets/img/dev_akademie_card.png" class="theme-visual_cards_dev" alt="dev akademie card" />
                  <img src="assets/img/git_card.png" class="theme-visual_cards_git" alt="git card" />
                </div>
              </div>`;

export const gamingSelectionTemplate = `<div class="theme-visual-game">
                <div class="theme-visual_header-game">
                ...
                <div class="theme-visual-game_cards">
                  <img src="assets/img/Card_Back.png" class="theme-visual-game_cards_game" alt="game back card" />
                  <img src="assets/img/Card_Front.png" class="theme-visual-game_cards_game-front" alt="game front card" />
                </div>
              </div>`;

export const daProjectsSelectionTemplate = `<div class="theme-visual-da">
                <div class="theme-visual_header-da">
                ...
                <div class="theme-visual-da_cards">
                  <img src="assets/img/da_computer_card_2.png" class="theme-visual-da_cards_da" alt="game back card" />
                  <img src="assets/img/da_shark_card.png" class="theme-visual-da_cards_da-front" alt="game front card" />
                </div>
              </div>`;
